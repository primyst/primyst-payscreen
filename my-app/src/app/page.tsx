  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        {/* Machine Container - No top padding */}
        <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
          {/* Machine + Receipt Section */}
          <div className="relative">
            {/* ATM Machine Entrance - Flat top, curved bottom */}
            <div className="relative bg-gradient-to-b from-gray-700 via-gray-600 to-gray-500 overflow-hidden" 
                 style={{ 
              ...
              <div className="flex">
                ...
                <div className="flex-1 pt-8 pb-6">
                  {/* Slot opening - Rectangle with no top radius */}
                  <div className="mx-4 rounded-b-2xl overflow-hidden relative" 
                       style={{ 
                         background: 'linear-gradient(to bottom, #000000 0%, #0a0a12 50%, #1a1a2e 100%)',
                         boxShadow: 'inset 0 8px 20px rgba(0,0,0,0.9), inset 0 -4px 10px rgba(255,255,255,0.05)'
                       }}>
                    <div className="h-12 relative">
                      {/* Inner darkness */}
                      <div className="absolute inset-0 bg-gradient-to-b from-black via-black/80 to-transparent"></div>
                      
                      {/* Bottom light where paper emerges */}
              ...
              {/* Machine shadows and highlights */}
              <div className="absolute inset-0 shadow-[inset_0_3px_15px_rgba(0,0,0,0.6)] pointer-events-none" 
                   style={{ 
                     borderTopLeftRadius: '1.5rem',
                     borderTopRightRadius: '1.5rem',
                     borderBottomLeftRadius: '2rem',
            ...
            {/* Receipt Paper - Emerges from behind the slot */}
            <div 
            ...
            >
              <div className="mx-6 bg-white rounded-b-2xl shadow-[0_8px_24px_rgba(0,0,0,0.12),0_-4px_12px_rgba(0,0,0,0.08)] relative">
                {/* Paper texture */}
                <div className="absolute inset-0 rounded-b-2xl opacity-[0.03] pointer-events-none"
                     style={{ backgroundImage: `repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,0,0,0.03) 2px, rgba(0,0,0,0.03) 4px)` }}></div>
                
                {/* Paper edge shadows */}
                <div className="absolute -left-1 top-0 bottom-0 w-2 bg-gradient-to-r from-black/10 to-transparent rounded-l-2xl"></div>
                <div className="absolute -right-1 top-0 bottom-0 w-2 bg-gradient-to-l from-black/10 to-transparent rounded-r-2xl"></div>
                <div className="absolute -top-2 inset-x-0 h-4 bg-gradient-to-b from-black/15 via-black/5 to-transparent"></div>
            ...
            {/* Printing indicator */}
            {isPrinting && (
              <div className="absolute top-4 right-4 bg-green-500 w-2 h-2 rounded-full animate-pulse shadow-lg z-50"></div>
            )}
          </div>

          {/* Spacer that grows as receipt prints */}
          <div style={{ height: `${printProgress >= 100 ? '720px' : '0px'}`, transition: 'height 0.3s ease-out' }}></div>

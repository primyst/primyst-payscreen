  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        {/* Machine + Receipt + Payment Section - All in one container */}
        <div className="bg-white rounded-3xl shadow-lg overflow-visible">
          <div className="p-6 pt-8">
            ...
            <div className="relative mb-6">
              ...
              {/* Animated Receipt Paper - Positioned relative to slot */}
              <div 
                className="absolute left-0 right-0 z-10"
                style={{
                  top: '5.5rem', // Position at the slot opening
